...
public class CrumbManager {
  ...
  private static void setCookie() {
    try {
      ...
      log.debug(
          "Failed to set cookie from http request. Intraday quote requests will most likely fail.",
          e);
    }
  }
  ...
  private static void setCrumb() {
    ...
    try {
      ...
      log.debug(
          "Failed to set crumb from http request. Intraday quote requests will most likely fail.",
          e);
    }
