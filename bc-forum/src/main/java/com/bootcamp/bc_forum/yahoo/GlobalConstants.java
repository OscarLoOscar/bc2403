...
//    */
//   public static final List<String> GT_LANGUAGE_CODES =
//       Arrays.asList("de", "en");
...
//   /**
//    * It will adjust the currency exchange rate or quotation for the cash account amount. Sometimes the user tries to get the total amount as exact as possible by adjusting the rate or exchange rate. In
//    * this case, the user interface rounds the calculated amount, thus only the rounded calculation results in the desired calculated amount. The backend can adjust the two parameters even more exactly
//    * with a rounding of FID_MAX_FRACTION_DIGITS.
//    */
...
//   public static final String STANDARD_LOCAL_DATE_TIME_SECOND =
//       "yyyy-MM-dd HH:mm:ss";
...
//   public static final String STANDARD_PASSWORD_REGEX =
//       "^(?=.*[A-Za-z])(?=.*\\d)[A-Za-z\\d]{8,}$";

//   /**
//    * Sometimes the EOD of the currency pair is not yet updated, in this case the existing current price can be taken if there are not more than so many days between the requested date and the current
//    * one.
//    */
//   public static final int MAX_DAY_DIFF_CURRENCY_UNTIL_NOW = 3;

//   /**
//    * The amount of time in minutes after the close of the relevant stock exchange that is waited before an update of historical prices is made.
//    */
...
//    */
//   public static final int TiME_MUST_HAVE_PASSED_SINCE_LAST_UPDATE_IN_MINUTES =
//       20 * 60;
...
//   /**
//    * Earliest Day for the next dividend check, but the combination of frequency and this value control the date of next possible check.
//    */
//   public static final int DIVIDEND_FROM_NOW_FOR_NEXT_CHECK_IN_DAYS = 8;

//   /**
//    * The number of cores for the fork join pool is multiplied by this value. This pool is used for the connectors of the EOD and last price.
//    */
...
//   public static final String USER_AGENT_HTTPCLIENT =
//       "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/89.0.4389.114 Safari/537.36";

//   public static final String UNITS = "units";

//   /**
//    * Contains the supported crypto currencies. When a new is added, check references. Maybe a connector must be extended to this new cryptocurrency.
//    */

//   public static final List<String> CRYPTO_CURRENCY_SUPPORTED =
//       List.of(CC_BTC, "BNB", "ETH", "ETC", "LTC", "XRP");
...
//   public static final int SPLIT_DAYS_LOCK_BACK_START_DATE =
//       SPLIT_DAYS_LOOK_BACK_END_DATE_BEFORE_SPLIT + 7;
...
//   /**
//    * It is possible that the split from the calendar was internally assigned to a wrong security, therefore after reaching this number of days the repetitive query to the connector is terminated.
//    */
...
//   /**
//    * User tries to access shared data outside its boundary. For example access history quotes of a security or currency pair which has no context to the tenant data.
//    */
//   public static final String STEAL_DATA_SECURITY_BREACH =
//       "steal.data.security.breach";
//   /**
//    * User tries to write tenant data outside the defined limits. For example a watchlist may have a maximum of instruments, if it is exceeded then this exception thrown.
//    */
...
//    */
//   public static final String FILED_EDIT_SECURITY_BREACH =
//       "field.edit.security.breach";
